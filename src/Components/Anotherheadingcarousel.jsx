...
const AnotherHeadlineCarousel = () => {
  // Define headlines and contents
  const slides = [
    {
      headline: 'Sales',
      content: {
        heading: 'More pipeline. Less effort.',
        button: 'See Sales Solutions',
        subheading: 'Surface actionable buying signals, uncover the person and account behind the signal, and automate personalized outreach at scale with our AI-powered copilot.Use AI to automate pipe-generating sales plays from signals like pricing views, product usages, job changes, and hundreds more.Put outbound on autopilot with workflows for end-to-end signal capture to action.Accelerate speed to lead with real-time Slack alerts triggered by top account activity.',
        image: 'signals.png'
      }
    },
    {
...
export default AnotherHeadlineCarousel;
